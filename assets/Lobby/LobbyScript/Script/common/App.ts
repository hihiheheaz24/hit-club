...
export default class App extends cc.Component {
    ...
    static DOMAIN = "hit9.live";
    static API_CMD: string = "https://ga.hit9.live/3rd/cmd";
    static API_IBC: string = "https://ga.hit9.live/3rd/ibc";
    static API_SBO: string = "https://ga.hit9.live/3rd/sbo"
    static API_AG: string = "https://ga.hit9.live/3rd/ag";
    static API_EBET: string = "https://ga.hit9.live/3rd/ebet";
    static API_WM: string = "https://ga.hit9.live/3rd/wm";

    //http://localhost:8081/api?c=2021&nn=tuanbigbird&at=1628224022&ip=127.0.0.1&mn=100
    updateConfigGame(domain = "hit9.live") {
    ...
    openGameV2(bundleName, sceneName, callback) {
    ...
    openMiniGameBauCuaV2(bundleName, prefabName, callback) {
        BundleControl.loadPrefabGame(bundleName, prefabName, (finish, total) => {
            callback(finish, total);
        }, (prefab, bundle) => {
            callback(100, 100, true);
    ...
    openMiniGameCaoThapV2(bundleName, prefabName,callback) {
        BundleControl.loadPrefabGame(bundleName, prefabName, (finish, total) => {
            callback(finish, total);
        }, prefab => {
            callback(100, 100, true);
    ...
    openMiniGameSlot3x3V2(bundleName, prefabName, callback) {
        BundleControl.loadPrefabGame(bundleName, prefabName, (finish, total) => {
            callback(finish, total);
        }, prefab => {
            callback(100, 100, true);
    ...
    openMiniGameSlot3x3GemV2(bundleName, prefabName, callback) {
        BundleControl.loadPrefabGame(bundleName, prefabName, (finish, total) => {
            callback(finish, total);
        }, prefab => {
            callback(100, 100, true);
    ...
    openMiniGameMiniPokerV2(bundleName, prefabName, callback) {
        BundleControl.loadPrefabGame(bundleName, prefabName, (finish, total) => {
            callback(finish, total);
        }, prefab => {
            callback(100, 100, true);
    ...
    public getGameName(gameID) {
        ...
        switch (gameID) {
            ...
            case 'benley':
                ...
                break;
            case 'maybach':
                gameName = "Sơn Tinh Thủy Tinh";
                break;
            case 'tamhung':
                gameName = "Cung Hỷ Phát Tài";
                break;
            case 'chiemtinh':
                gameName = "Ăn Khế Trả Vàng";
                break;
            case 'bikini':
                gameName = "Tây Du Ký";
                break;
