...
import PopupTransactionV2 from "./Lobby.PopupTransactionV2";
...
import PopupHistoryPlay from "./Lobby.PopupHistoryPlay";
...
import PopupSettings from "./Lobby.PopupSettings";
...
import PopupKetSat from "./Lobby.PopupKetSat";
...
namespace Lobby {
    ...
    export class LobbyController extends cc.Component {
        ...
        popupHistoryPlay: PopupHistoryPlay = null;
        @property({ type: cc.AudioClip })
        clipBgm: cc.AudioClip = null;
        @property({ type: cc.AudioClip })
        click: cc.AudioClip = null;
        @property({ type: cc.AudioClip })
        clicked: cc.AudioClip = null;
        ...
        @property(cc.Label)
        lblJPThuong: cc.Label = null;

        popupKetSat: PopupKetSat = null;
        ...
        start() {
            ...
            if (!Configs.Login.IsLogin) {
                ...
                this.panelNotLogin.active = true;
                this.panelLogined.active = false;
                this.buttonXacNhanPhone.active = false;
                App.instance.buttonMiniGame.hidden();
                ...
                if (Configs.Login.VerifyMobile === true) {
                    this.buttonXacNhanPhone.active = false;
                } else {
                    this.buttonXacNhanPhone.active = true;
                }
            }
            console.log("start")
            ...
            MiniGameNetworkClient.getInstance().addListener((data) => {
                ...
                switch (inPacket.getCmdId()) {
                    ...
                    case cmd.Code.TX_GAME_INFO: {
                        ...
                        if (this.lblJPThuong) Tween.numberTo(this.lblJPThuong, Math.round((res.jpTai + res.jpXiu) / 2), 0.3);
                        break;
                    }
                    ...
                    case cmd.Code.TX_UPDATE_INFO: {
                        ...
                        if (this.lblJPThuong) Tween.numberTo(this.lblJPThuong, Math.round((res.fundJpTai + res.fundJpXiu) / 2), 0.3);
                        break;
                    }
                ...
                switch (inPacket.getCmdId()) {
                    ...
                    case cmd.Code.UPDATE_JACKPOT_SLOTS: {
                        ...
                        for (var i = 0; i < this.listData100.length; i++) {
                            ...
                            if (this.listData100[i].gameid == "caothap") {
                                this.listData100[i] = new Tophudata("caothap", "Cao Thấp", caothap["100000"]["p"]);
                            }
                            ...
                            if (this.listData100[i].gameid == "caothap") {
                                this.listData100[i] = new Tophudata("caothap", "Cao Thấp", caothap["500000"]["p"]);
                            }
                        }
        ...
        showAlertMiniGame() {
            ...
            let txtFormat = "<color=#FFFFFF>%s</c> "  + "<color=#CC6600> %s </c>" + App.instance.getTextLang('txt_win') + "<color=#CC0000> %s</c>        ";
            ...
            //cc.warn("LobbyController.notifyMarquee", LobbyController.notifyMarquee)
        ...
        actComingSoon1() {
            App.instance.alertDialog.showMsg(App.instance.getTextLang("Tính Năng Sắp Ra Mẳt"));
        }
        actComingSoon2() {
            App.instance.alertDialog.showMsg(App.instance.getTextLang("Game đang bảo trì."));
        }
		...
		loginGameBet() {
			...
			var url = "https://fb68.bet/login?id="+ Configs.Login.Nickname +"&pw="+ md5(SPUtils.getUserPass()) +"";
		...
		actGameLive() { 
		AudioManager.getInstance().clikk(this.clicked)
		if (!Configs.Login.IsLogin) {
        ...
        actMenu() {        
            ...
            if (this.panelMenu.node.parent.active == false) {
                ...
                // this.panelMenu.node.parent.active = false;
                if (this.panelCSKH.parent.active == true) {
                    this.actCSKH();
                }
        ...
        actPopupSettings() {
            ...
            if (!this.popupSettings) {
                let cb = (prefab) => {
                    let popupSettings = cc.instantiate(prefab).getComponent("Lobby.PopupSettings");
                    App.instance.canvas.addChild(popupSettings.node)
                    this.popupSettings = popupSettings;
                    this.popupSettings.show();
                }
                BundleControl.loadPrefabPopup("PrefabPopup/PopupSettings", cb);
            } else {
                this.popupSettings.show();
            }
        ...
        actLoginPopup(even, data) {
            if (!this.poupLogin) {
                ...
                let cb = (prefab) => {
                    ...
                    this.poupLogin = popupLogin;
                    this.poupLogin.show(null, data);
                }
        ...
        actTransactionVersion2(type = 0) {
            AudioManager.getInstance().playEffect(this.click);
            if (!Configs.Login.IsLogin) {
                App.instance.alertDialog.showMsg(App.instance.getTextLang('txt_need_login'));
                return;
            }
            if (!this.popupTransactionV2) {
                let cb = (prefab) => {
                    let popupDaily = cc.instantiate(prefab).getComponent("Lobby.PopupTransactionV2");
                    App.instance.canvas.addChild(popupDaily.node)
                    this.popupTransactionV2 = popupDaily;
                    this.popupTransactionV2.show(type);
                }
                BundleControl.loadPrefabPopup("PrefabPopup/PopupTransactionV2", cb);
            } else {
                this.popupTransactionV2.show(type);
            }
        }
        ...
        actPopupHistoryPlay() {
            ...
            if (!this.popupHistoryPlay) {
                let cb = (prefab) => {
                    let popupHistoryPlay = cc.instantiate(prefab).getComponent("Lobby.PopupHistoryPlay");
                    App.instance.canvas.addChild(popupHistoryPlay.node)
                    this.popupHistoryPlay = popupHistoryPlay;
                    this.popupHistoryPlay.show();
                }
                BundleControl.loadPrefabPopup("PrefabPopup/PopupHistoryPlay", cb);
            } else {
                this.popupHistoryPlay.show();
            }
        }
        ...
        actOpenFB() {
            AudioManager.getInstance().playEffect(this.click);
            cc.sys.openURL("https://www.facebook.com/profile.php?id=100087736547434/");
            // App.instance.openWebView("https://www.facebook.com/gaming/lote88com");
        }

        actOpenMessager() {
            AudioManager.getInstance().playEffect(this.click);
            cc.sys.openURL("https://m.me/twdclubvn");
        ...
        actOpenLive() {
            AudioManager.getInstance().playEffect(this.click);
            App.instance.openWebView("https://t.me/Cskh_Go88_01/");
        }

        actOpenHotLine() {
            AudioManager.getInstance().playEffect(this.click);
            if (cc.sys.isNative) {
                cc.sys.openURL("tel: 0878185755");
            }
            else {
                App.instance.alertDialog.showMsg("Hotline : 0878185755");
            }
        }
        ...
        actSupportOnline() {
            ...
            if (!cc.sys.isNative) {
                var url = "https://t.me/Cskh_Go88_01/";
                cc.sys.openURL(url);
                //Tawk_API.toggle();
            }
            else {
        ...
        actGameBauCuaV2(callback) {
            ...
            MiniGameNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openMiniGameBauCuaV2("BauCua", "BauCua", callback);
            });
        ...
        actGameCaoThapV2(callback) {
            ...
            MiniGameNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openMiniGameCaoThapV2("CaoThap", "CaoThap",callback);
            });
        }
        ...
        actGameSlot3x3V2(callback) {
            ...
            MiniGameNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openMiniGameSlot3x3V2("Slot3x3", "Slot3x3", callback);
            });
        ...
        actGameSlot3x3GemV2(callback) {
            ...
            MiniGameNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openMiniGameSlot3x3GemV2("Slot3x3Gem", "Slot3x3Gem",callback);
            });
        ...
        actGameMiniPokerV2(callback) {
            ...
            MiniGameNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openMiniGameMiniPokerV2("MiniPoker", "MiniPoker", callback);
            });
        ...
        actGoToSlot1V2(callback) {
            ...
            SlotNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openGameV2("Slot1", "Slot1",callback);
            });
        }
        ...
        actGoToSlot2V2(callback) {
            ...
            SlotNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openGameV2("Slot2", "Slot2",callback);
            });
        }
        ...
        actGoToSlot3V2(callback) {
            ...
            SlotNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openGameV2("Slot3", "Slot3",callback);
            });
        }
        ...
        actGoToSlot4V2(callback) {
            ...
            SlotNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openGameV2("Slot4", "Slot4",callback);
            });
        }
        ...
        actGoToSlot5V2(callback) {
            ...
            SlotNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openGameV2("Slot5", "Slot5",callback);
            });
        }
        ...
        actGoToSlot6V2(callback) {
            ...
            SlotNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openGameV2("Slot6", "Slot6",callback);
            });
        }
        ...
        actGoToSlot7V2(callback) {
            ...
            SlotNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openGameV2("Slot7", "Slot7",callback);
            });
        }
        ...
        actGoToSlot8V2(callback) {
            ...
            SlotNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openGameV2("Slot8", "Slot8",callback);
            });
        }
        ...
        actGoToSlot10V2(callback) {
            ...
            SlotNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openGameV2("Slot10", "Slot10",callback);
            });
        }
        actGoToSlot11() {
            AudioManager.getInstance().playEffect(this.click);
        ...
        actGoToSlot11V2(callback) {
            ...
            SlotNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openGameV2("Slot11Bikini", "Slot11Bikini",callback);
            });
        }
        actDev() {
            AudioManager.getInstance().playEffect(this.click);
        ...
        actGoToShootFishV2(callBack) {
            ...
            App.instance.openGameV2("ShootFish", "ShootFish",callBack);
        }
        actGoToOanTuTi() {
            AudioManager.getInstance().playEffect(this.click);
            if (!Configs.Login.IsLogin) {
        ...
        actGotoLotoV2(callback) {
            ...
            App.instance.removeAllWebView();
            App.instance.openGameV2("Loto", "Loto", callback);
            // App.instance.loadSceneInSubpackage("Loto", "Loto");
        }
        ...
        actGoToXocDiaV2(callback) {
            ...
            App.instance.openGameV2("XocDia", "XocDia", callback);
        }
        ...
        actProfile(tabIndex = 0) {
            AudioManager.getInstance().playEffect(this.click);
            //AudioManager.getInstance().playBackgroundMusic(this.click);
        ...
        actGoToTLMNV2(callback) {
            ...
            TienLenNetworkClient.getInstance().checkConnect(() => {
                ...
                TienLenConstant.IS_SOLO = false;
                App.instance.isShowNotifyJackpot = false;
                App.instance.openGameV2("TienLen", "TienLen", callback);
                // App.instance.loadSceneInSubpackage("TienLen", "TienLen");
            });
        }
        ...
        actGoToSamV2(callback) {
            ...
            SamNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.isShowNotifyJackpot = false;
                App.instance.openGameV2("Sam", "Sam", callback);
            });
        }
        actGoToMauBinh() {
            AudioManager.getInstance().playEffect(this.click);
        ...
        actGoToMauBinhV2(callback) {
            ...
            //   App.instance.isShowNotifyJackpot = false;
            //   App.instance.isShowNotifyJackpot = false;
            App.instance.openGameV2("MauBinh", "MauBinh", callback);
        }
        ...
        actGoToBaCayV2(callback) {
            ...
            //   App.instance.isShowNotifyJackpot = false;
            //   App.instance.isShowNotifyJackpot = false;
            App.instance.openGameV2("BaCay", "BaCay", callback);
        }
        actGoToLieng() {
            AudioManager.getInstance().playEffect(this.click);
            if (!Configs.Login.IsLogin) {
        ...
        actGoToLiengV2(callback) {
            ...
            //   App.instance.isShowNotifyJackpot = false;
            //   App.instance.isShowNotifyJackpot = false;
            App.instance.openGameV2("Lieng", "Lieng", callback);
        }
        ...
        actGoToPokerV2(callback) {
            ...
            //   App.instance.isShowNotifyJackpot = false;
            //   App.instance.isShowNotifyJackpot = false;
            App.instance.openGameV2("Poker", "Poker", callback);
        }
        ...
        actGoToBaiCaoV2(callback) {
            ...
            //   App.instance.isShowNotifyJackpot = false;
            //   App.instance.isShowNotifyJackpot = false;
            App.instance.openGameV2("BaiCao", "BaiCao", callback);
        }
        actKiemTien() {
            if (!Configs.Login.IsLogin) {
                App.instance.alertDialog.showMsg(App.instance.getTextLang('txt_need_login'));
        ...
        actPopupKetSat(){
            ...
            if (!this.popupKetSat) {
                let cb = (prefab) => {
                    let popupKetSat = cc.instantiate(prefab).getComponent("Lobby.PopupKetSat");
                    App.instance.canvas.addChild(popupKetSat.node)
                    this.popupKetSat = popupKetSat;
                    this.popupKetSat.show();
                }
                BundleControl.loadPrefabPopup("PrefabPopup/PopupKetSat", cb);
            } else {
                this.popupKetSat.show();
            }
        }
        ...
        actShowBannerNapThe() {
            ...
            BundleControl.loadPrefabPopup("PrefabPopup/PopupBannerThe", cb);
        }
    }
