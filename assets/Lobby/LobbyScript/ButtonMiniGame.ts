...
export default class ButtonMiniGame extends cc.Component {
    ...
    @property(cc.Label)
    labelTimePanelMd5: cc.Label = null;
                ...
                case cmd.Code.UPDATE_TIME_BUTTON:
                    {
                        ...
                        seft.labelTime.string = res.remainTime > 9 ? res.remainTime.toString() : "0" + res.remainTime;
                        seft.labelTimePanel.string = res.remainTime > 9 ? res.remainTime.toString() : "0" + res.remainTime;
                    }
                    break;
                case cmd.Code.UPDATE_TIME_BUTTON_MD5:
                    {
                        let res = new cmd.ReceiveUpdateTimeButton(data);
                        seft.labelTimePanelMd5.string = res.remainTime > 9 ? res.remainTime.toString() : "0" + res.remainTime;
                    }
                break;
            }
        }, this);
