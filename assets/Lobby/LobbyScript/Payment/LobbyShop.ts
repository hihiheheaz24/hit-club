...
export default class LobbyShop extends Dialog {
    ...
    actShowPopupHistory(){
        Global.LobbyController.actTransactionVersion2(0);
    }
    ...
    showTabsAlive() {
        ...
        if (this.btnTabs[NAME_TABS["chuyenkhoan"]] != null) {
            this.btnTabs[NAME_TABS["chuyenkhoan"]].active = false;
        }
        if (this.btnTabs[NAME_TABS["princepay"]] != null) {
            this.btnTabs[NAME_TABS["princepay"]].active = false;
        }
    }
