...
export namespace cmd {
    export class Code {
        ...
        static readonly DEPOSIT_BANK_NEW = 20205;
        static readonly UPDATE_TIME_BUTTON_MD5 = 22124;

        static readonly NAP_KET_SAT = 20310;
        static readonly GET_KET_SAT = 20311;
        static readonly RUT_KET_SAT = 20312;
    }

    export class ReqGetKetSat extends OutPacket {
        constructor() {
            super();
            this.initData(100);
            this.setControllerId(1);
            this.setCmdId(Code.GET_KET_SAT);
            this.packHeader();
            this.updateSize();
        }
    }

    export class ResGetKetSat extends InPacket {
        error = 0;
        currentMoney = 0;
    ...
    export class ReqNapTienKet extends OutPacket {
        constructor( amount: number) {
            super();
            this.initData(100);
            this.setControllerId(1);
            this.setCmdId(Code.NAP_KET_SAT);
            this.packHeader();
            this.putLong(amount);
            this.updateSize();
        }
    ...
    export class ResNapTienKet extends InPacket {
        error = 0;
        constructor(data: Uint8Array) {
            super(data);
            this.error = this.getError();   
    ...
    export class ResRutTienKet extends InPacket {
        error = 0;
        constructor(data: Uint8Array) {
            super(data);
            this.error = this.getError();
    ...
    export class ReqRutTienKet extends OutPacket {
        constructor( amount: number, otp: string) {
            super();
            this.initData(100);
            this.setControllerId(1);
            this.setCmdId(Code.RUT_KET_SAT);
            this.packHeader();
            this.putLong(amount);
            this.putString(otp);
            this.updateSize();
    ...
    export class ReqDepositBankNew extends OutPacket {
        constructor(bankNumber: string, amount: number) {
            super();
            this.initData(100);
            this.setControllerId(1);
            this.setCmdId(Code.DEPOSIT_BANK_NEW);
            this.packHeader();
            this.putString("");
            this.putString(bankNumber)
            this.updateSize();
    ...
    export class ResDepositBankNew extends InPacket {
        error = 0;
        data = "";
