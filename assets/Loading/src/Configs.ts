...
namespace Configs {
    ...
    export class App {
        ...
        static API: string = "https://iportal.hit9.live/api";
		static API2: string = "https://iportal2.hit9.live/api";
		static APIROY: string = "https://portal.hit9.live/api";
        static API_PAYIN_PAYWELL_BANKS: string = "https://iportal.eloras.icu/api/payin/paywell/banks";
        static MONEY_TYPE = 1;
        static LINK_DOWNLOAD = "https://twd88.club";
        static LINK_EVENT = "https://eloras.icu/event";
        static LINK_SUPPORT = "https://eloras.icu";
        static USE_WSS = false;
        static LINK_GROUP = "https://www.facebook.com/profile.php?id=100087736547434/";
        ...
        static GameName = {
            110: "Kho Tàng Ngũ Long",
            170: "The Witcher",
            2: "Tài Xỉu",
            5: "Xèng",
            11: "Tiến Lên",
            160: "Cung Hỷ Phát Tài", // chimdien
            120: "Thần Tài",
            150: "Sơn Tinh Thủy Tinh", // The thao
            1: "MiniPoker",
            3: "Bầu Cua",
            9: "Ba Cây",
            4: "Cao Thấp",
            191: "Ăn Khế Trả Vàng", // chiemtinh
            190: "Tài Xỉu Siêu Tốc",
            12: "Xóc Đĩa",
            180: "Kho Báu Tứ Linh", // thanbai
        ...
        static readonly CASHOUT_CARD_CONFIG = {
            listTenNhaMang: ["Viettel", "Vinaphone", "Mobifone", "Garena", "Vcoin", "FPT Gate", "Mobi Data"],
            listIdNhaMang: ["VTT", "VNP", "VMS", "GAR", "VTC", "FPT", "DBM"],
            listMenhGiaNapThe: [10000, 100000, 200000, 500000],
            listQuantity: ["1", "2", "3"]
        }
        static readonly HOST_SOCKJS = "https://st.hit9.live/";
        ...
        static getLinkFanpage() {
            switch (VersionConfig.CPName) {
                default:
                    return "https://www.facebook.com/twdclubvn";
            }
        }
