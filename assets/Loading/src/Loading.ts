...
export default class Loading extends cc.Component {
    ...
    listTips = [
        ...
        {
            vi: "Vina99 nạp rút nhanh chóng và an toàn!",
            en: "Vina99 quick cashin,cashout and alway safety!"
        },
    ]
    start() {
    ...
    startGame() {
		...
		cc.sys.localStorage.setItem("domain", "remote.hit9.live");    
        cc.sys.localStorage.setItem("api", "https://iportal.hit9.live/api"); 

        if (Configs.App.IS_LOCAL == false) {
            Http.get("https://remote.hit9.live/assets/AssetBundleVersion.json", {}, (err, data) => {
